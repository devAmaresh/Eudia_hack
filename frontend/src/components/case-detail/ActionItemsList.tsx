    ...
    return (
      <Card className="border-zinc-800/80 bg-zinc-900/50 shadow-lg">
        <CardContent className="text-center py-12">
          <CheckSquare className="h-16 w-16 text-zinc-600 mx-auto mb-3" strokeWidth={1.5} />
          <p className="text-sm font-semibold text-zinc-500">No action items yet</p>
        </CardContent>
      </Card>
    );
  }
  ...
  return (
    <div className="space-y-3">
      {actionItems.map((item: ActionItem) => (
        <Card key={item.id} className="border-zinc-800/80 bg-zinc-950 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex items-start gap-4 flex-1">
                ...
                <div className="flex-1">
                  <h3 className="font-bold text-sm text-white tracking-tight mb-1">{item.description}</h3>
                  {item.due_date && (
